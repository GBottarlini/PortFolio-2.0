        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Durante mi tiempo en la universidad, participé en{" "}
              {DATA.hackathons.length}+ hackathons. Personas de todo el país se
              reunían para construir cosas increíbles en 2 o 3 días. Fue
              inspirador ver las posibilidades que se pueden lograr con un
              equipo motivado y apasionado.
            </p>
          </div>
        </div>
        <Timeline>
